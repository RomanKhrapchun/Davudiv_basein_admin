...
const debtorRepository = require("../repository/debtor-repositiry");
...
const { displayDebtorFields, allowedDebtorTableFilterFields } = require("../../../utils/constans");
...
class DebtorService {
    ...
    async findDebtByFilter(request) {
        ...
        const userData = await debtorRepository.findDebtByFilter(limit, offset, title, allowedFields, displayDebtorFields)
