...
import {booleanArray, generateIcon, iconMap, monthList, STATUS} from "../../utils/constans";
...
import AsyncSelect from "../../components/common/AsyncSelect/AsyncSelect.jsx";
                        ...
                        <div className="table-elements">
                            ...
                            <div className="table-main">
                                ...
                                <div className={`table-filter ${stateLog.isOpen ? "table-filter--active" : ""}`}>
                                    ...
                                    <div className="table-filter__item">
                                        <RangePicker
                                            startRangeTitle={"Початкова дата"}
                                            endRangeTitle={"Кінцева дата"}
