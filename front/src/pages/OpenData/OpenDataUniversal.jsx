...
const OpenDataUniversal = () => {
    const { tableId, action, id } = useParams(); // Destructure tableId, action, and id from params
    ...
    switch (tableId) {
        ...
        case '1.1':
            if (action === 'view') {
                component = <Index1_1View />;
            } else if (action === 'edit') {
                component = <Index1_1Edit />;
            } else {
                component = <Index1_1 />; // Default to Index1_1 if no action is specified
            }
            break;
        case '1.2':
            if (action === 'view') {
                component = <Index1_2View />;
            } else if (action === 'edit') {
                component = <Index1_2Edit />;
            } else {
        ...
        case '1.3':
            if (action === 'view') {
                component = <Index1_3View />;
            } else if (action === 'edit') {
                component = <Index1_3Edit />;
            } else {
        ...
        case '2':
            if (action === 'view') {
                ...
                component = <Index2Edit />;
            } else {
                component = <Index2 />; // Default to Index1_3 if no action is specified
            }
            break;
        case '3':
            if (action === 'view') {
        ...
        case '43':
            if (action === 'view') {
                component = <Index43View />;
            } else if (action === 'edit') {
                component = <Index43Edit />;
            } else {
