...
const DebtorList = () => {
        ...
        const resetFilters = () => {
            ...
            const applyFilter = () => {
                // 1️⃣  Чи заповнений хоч один інпут
                const isAnyInputFilled = Object.values(stateDebtor.selectData).some(value => {
                ...
                // 3️⃣  Конвертуємо єдиний числовий інпут у Number
                //     (залишаємо undefined, якщо поле пусте)
                const debtNum = dataValidation.debt_amount !== ''
                  ? Number(dataValidation.debt_amount)
                  : undefined;                                    // ⬅️ додано
              
                // 4️⃣  Оновлюємо sendData: додаємо debt_amount
                setStateDebtor(prevState => ({
                  ...prevState,
                  sendData: {
                    ...prevState.sendData,                        // зберігаємо limit/page
                    ...dataValidation,                            // інші фільтри, якщо є
                    debt_amount: debtNum,                         // ⬅️ додано
                    page: 1,
                  },
                }));
              };
                            ...
                            <div className="table-main">
                                ...
                                <div className={`table-filter ${stateDebtor.isOpen ? "table-filter--active" : ""}`}>
                                    ...
                                    <div className="table-filter__item">
                                        ...
                                        <div className="table-filter__item">
                                        <h4 className="input-description">Сума боргу (₴)</h4>
                                        <Input
                                        icon={searchIcon}
                                        name="debt_amount"          // ← таке саме ім’я, яке ви обробляєте у applyFilter
                                        type="number"
                                        step="0.01"
                                        placeholder="Напр. 5000"
                                        value={stateDebtor.selectData.debt_amount || ''}
                                        onChange={onHandleChange}
                                        />
                                    </div>
                                </div>
