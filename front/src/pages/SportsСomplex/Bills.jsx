...
const Bills = () => {
                        ...
                        return (
                            <div className="btn-sticky" style={{ justifyContent: 'center' }}>
                                <Button
                                    ...
                                    icon={viewIcon}
                                    onClick={() => navigate(`/bills/${record.id}/requisites`)}
                                />
                                <Button
                                    title="Скасувати"
                                    icon={cancelIcon}
    ...
    const handleCreateFormSubmit = async () => {
        const { account_number, payer, service_group_id, service_id, quantity } = createModalState.formData;
        
        // Валідація форми
        if (!account_number || !payer || !service_group_id || !service_id || !quantity) {
            notification({
                type: 'warning',
                placement: 'top',
                title: 'Помилка',
