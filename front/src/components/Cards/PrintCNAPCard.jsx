...
import { generateIcon, iconMap, STATUS } from "../../utils/constans.jsx";
import Loader from "../Loader/Loader.jsx";
import PageError from "../../pages/ErrorPage/PageError.jsx";
import { formatDateUa } from "../../utils/function.js";
import { territory_title, phone_number_GU_DPS, website_url, telegram_url, alt_qr_code,website_url_p4v } from "../../utils/constans.jsx";
        ...
        <React.Fragment>
            {status === STATUS.SUCCESS ? (
                <div className="print-card">
                    ...
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{territory_title} повідомляє, що відповідно до даних ГУ ДПС у Львівській області,
                    ...
                    <p>&nbsp;</p>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;В разі виникнення питань по даній заборгованості, звертатись у ГУ ДПС у Львівській області за номером телефона {phone_number_GU_DPS}.</p>
